...
public class GraphicsDemo3 extends Canvas {
    public void paint(Graphics g) {
        ...
        // Make a short red line that is roughly perpendicular to the
         // diagonal "magenta" line.
        g.setColor(Color.red);
        g.drawLine(200,50,200,150);
        g.drawLine(200,350,100, 230);
        g.setColor(Color.green);
        g.drawLine(10,100,400,100);
        g.setColor(Color.blue);
        g.drawLine(50,150,400,180);
